...
iKettle.prototype.turnOn = function(me) {
  return this._sendCommand('TURN_ON').then(function() {
    me.status.isOn = true;
  });
}

iKettle.prototype.turnOff = function(me) {
  return this._sendCommand('TURN_OFF').then(function() {
    me.status.isOn = false;
  });
}
